...
<div id="itvs" class="content-panel active"><br>
    <div class="container mt-5">
        <div class="row">
            <c:forEach var="mantenimiento" items="${listaMantenimiento}" varStatus="status">
                <div class="card-deck col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="card card-custom">
                        <div class="card-body">
                        <div class="d-flex justify-content-between">
                            	<h5 class="card-title mb-0"><fmt:formatDate value="${mantenimiento.fecha}" pattern="dd-MM-yyyy"/></h5>
                            	<h5 class="card-title mb-0">${mantenimiento.kmMantenimiento}km</h5>
                            </div>
                            <br>
                            ...
                            <div class="d-flex justify-content-between">
							    ...
							    <p class="card-text mb-0">
							        <strong>${mantenimiento.precio}€</strong>
							    </p>
							</div>
                        </div>
