...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Listado de Repostajes</li>
    </ol>
</nav>
...
<div id="itvs" class="content-panel active"><br>
    <div class="container mt-5">
        <div class="row">
            <c:forEach var="repostaje" items="${listaRepostajes}" varStatus="status">
                <div class="card-deck col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="card card-custom">
                        <div class="card-body">
                        <div class="d-flex justify-content-between">
                            	<h5 class="card-title mb-0"><fmt:formatDate value="${repostaje.fecha}" pattern="dd-MM-yyyy"/></h5>
                            	<h5 class="card-title mb-0">${repostaje.kmRepostaje}km</h5>
                            </div>
                            <br>
                            <p class="card-text">Repostaje en REPSOL</p>
                            <div class="d-flex justify-content-between">
<%-- 							    <p class="card-text mb-0">${mantenimiento.categoria.descripcion}</p> --%>
							    <p class="card-text mb-0">
							        <strong>${repostaje.precio}€</strong>
							    </p>
							</div>
                        </div>
